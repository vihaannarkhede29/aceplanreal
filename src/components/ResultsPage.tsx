...
import { ExternalLink, Star, RefreshCw, Facebook, Twitter, Download, ChevronDown, User } from 'lucide-react';
...
export default function ResultsPage({ results, onRetakeQuiz }: ResultsPageProps) {
  ...
  const handleShare = (platform: 'facebook' | 'twitter') => {
    ...
    const text = `Check out my personalized tennis equipment recommendations!`;
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 mb-6">
          Based on your profile as a {results.skillLevel.toLowerCase()} {results.playingStyle.toLowerCase()} player
        </p>
        <div className="flex justify-center space-x-4 flex-wrap gap-4">
          ...
          <button
            ...
            className="flex items-center space-x-2 px-6 py-3 bg-sky-500 text-white rounded-lg hover:bg-sky-600 transition-colors"
          >
      ...
      <div className="text-center bg-gray-50 rounded-xl p-8">
        <h3 className="text-2xl font-bold text-gray-900 mb-4">
          Ready to Transform Your Tennis Game?
        </h3>
        <p className="text-gray-600 mb-6">
          Your personalized AcePlan includes equipment recommendations and a complete training program. 
          Start with our top pick and follow your training calendar for maximum results!
        </p>
        <button
          onClick={onRetakeQuiz}
